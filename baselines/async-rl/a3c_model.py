...
def build_policy_and_value_networks(num_actions, agent_history_length, resized_width, resized_height):
    with tf.device("/cpu:0"):
        ...
        p_out = policy_network(state)  # actions probability
        v_out = value_network(state)   # value network value of current state.
