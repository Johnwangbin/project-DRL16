...
def build_graph():
    ...
    p_loss = -log_prob * (R_t - v_network)  # loss from policy gradient.
    v_loss = tf.reduce_mean(tf.square(R_t - v_network))  # loss from value network supervision
